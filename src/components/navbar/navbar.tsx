    ...
    <div className={styles.container} ref={ref}>
        ...
        <ul className={styles.goonjlogo}>
          <Link href="/">
            <Image
              ...
              src="https://firebasestorage.googleapis.com/v0/b/goonj-2k24.appspot.com/o/goonj24logo_white.png?alt=media&token=e4a4ee6a-ac40-4596-bac5-d2826dc03038"
              alt="Goonj"
              width={2789}
              height={1000}
            />
      ...
      <nav className={styles.socials} id="bottom">
        <ul style={{ backgroundColor: color }}>
          ...
          <li>
            <Link href="mailto: contact@goonjuiet.com">
              <Image
                src="/logos/at.png"
                alt="Email"
                width={logoSize}
