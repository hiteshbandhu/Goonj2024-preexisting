  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.uiet}>
        <p>
          University Institute of Engineering and Technology (UIET) was
          established in 2002 and is an in-campus Department of Panjab
          University, Chandigarh. The whole campus is Wi-Fi enabled. UIET is
          spread over 10.5 acres of land with lush greenery. It has Three
          Academic Blocks and one dedicated Workshop. Nearly 2500 students
          comprise from all parts of the country and a few from Abroad too. UIET
          has prospered by leaps & bounds over the years achieving great
          academic heights besides foraying into the top 50 engineering colleges
          in the country.
        </p>
        <Image
      ...
      <div className={styles.pu}>
        <p>
          Panjab University Chandigarh established in 1882 (earlier as
          University of Punjab) has 78 teaching and research departments at its
          main campus located in Chandigarh.
          <br />
          <br />
          University campus is spread over an area of 550 acres in sectors 14
          and 25 of the city of Chandigarh.
        </p>
        <Image
      ...
      <div className={styles.goonj}>
        <p>
          Goonj is the annual Techno-Cultural fest of UIET is organised by the
          students. The spirit of the fest is to promote the cultural as well as
          the technical alacrity among the students. Moreover, the motive is to
          spread a zeal among students relieving them from the stressful
          schedule of an engineering atmosphere. Goonj 2024 is well said to be
          the flagship event of UIET, and is now going to be more prestigious
          and fun filled.
          <br />
          <br />
          ...
          Show, EDM Night and STAR Night. The event will be hosting more than
